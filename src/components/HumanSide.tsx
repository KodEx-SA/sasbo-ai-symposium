      ...
      <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-300 leading-relaxed">
            ...
            sector—our mandate is to ensure that workers aren't left behind but
            are instead equipped, empowered, and protected as change unfolds.
          </p>
        ...
        <div className="bg-primary-purple/50 rounded-2xl p-8 border border-primary-blue/30">
          <div className="aspect-video bg-gradient-to-br from-purple-600 via-blue-600 to-cyan-500 rounded-lg flex items-center justify-center relative overflow-hidden">
