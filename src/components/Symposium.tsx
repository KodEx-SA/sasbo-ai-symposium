...
export default function Symposium() {
  ...
  return (
    <section id="conversations" className="section-container">
      {/* Section Title */}
      <ScrollAnimation>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto mb-16">
        {conversations.map((conv, index) => (
          <ScrollAnimation key={index} delay={0.1 * index}>
            <div className="bg-blue-900/40 rounded-xl p-6 border border-primary-light-blue/20 hover:border-primary-cyan/50 transition-all hover:transform hover:scale-105 h-full">
      ...
      <ScrollAnimation delay={0.3}>
        <div className="relative max-w-6xl mx-auto">
          <div className="bg-gradient-to-r from-blue-900/50 to-blue-900/50 rounded-2xl p-8 border border-primary-light-blue/30">
